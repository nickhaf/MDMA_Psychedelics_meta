...
$I^2$ telss us how much heterogeneity is due to differences within studies (level 2), and how much is due to between study-differences (level 3). So it answers the question if the effect sizes from the same study are more similar than effect sizes from multiple studies. 
